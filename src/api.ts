...
type IsCaseMatched<E extends keyof Endpoints, P extends Endpoints[E]['req'], C extends number> =
	IsNeverType<StrictExtract<Endpoints[E]['res']['$switch']['$cases'][C], [P, any]>> extends false ? true : false; // eslint-disable-line @typescript-eslint/no-explicit-any

type GetCaseResult<E extends keyof Endpoints, P extends Endpoints[E]['req'], C extends number> =
	StrictExtract<Endpoints[E]['res']['$switch']['$cases'][C], [P, any]>[1]; // eslint-disable-line @typescript-eslint/no-explicit-any
...
export class APIClient {
	...
	constructor(opts: {
		...
		this.fetch = opts.fetch || ((...args): Promise<Response> => fetch(...args));
	}

	public request<E extends keyof Endpoints, P extends Endpoints[E]['req']>(
		endpoint: E, params: P = {} as P, credential?: string | null | undefined,
	): Promise<Endpoints[E]['res'] extends { $switch: { $cases: [any, any][]; $default: any; }; } // eslint-disable-line @typescript-eslint/no-explicit-any
		?
