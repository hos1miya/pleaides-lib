...
export default class Stream extends EventEmitter<StreamEvents> {
	 ...
	 */
	@autobind
	public send(typeOrPayload: string | Record<string, unknown> | unknown[], payload?: unknown): void { // eslint-disable-line @typescript-eslint/no-explicit-any
...
class Pool {
	...
	public users = 0;
	private disposeTimerId: NodeJS.Timeout | null = null;
